                    ...
                    with left:
                        ...
                        try:
                            ...
                            if check_existing_document is None:
                                ...
                                st.info('Please Database Migration to view and migrate the channel data to SQl',icon='ℹ️')
                            else:
...
# migrating data from Mysql database====================================================================================
        with sql:
            st.markdown("## :red[MYSQL DATABASE - ***SQL***]")
            st.markdown(':red[MIGRATE DATA FROM NOSQL TO SQL] ')
